...
# Compile definitions
set(KLEIDIAI_OPS_COMPILE_DEFINES $<$<CONFIG:Release>:NDEBUG>
                                 $<$<BOOL:${KLEIDIAI_OPS_ENABLE_SILENT}>:SILENT>)

if(KLEIDIAI_OPS_ENABLE_FP16)
    list(APPEND KLEIDIAI_OPS_COMPILE_DEFINES ENABLE_FP16_KERNELS)
endif()
