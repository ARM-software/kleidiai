...
)
{
  ...
  __asm__ __volatile__(
    ...
    "ld1b { z14.h }, p4/Z, [x14]\n"
    "ld1b { z5.h }, p4/Z, [x14, #1, MUL VL]\n"
    "ld1b { z4.h }, p4/Z, [x14, #2, MUL VL]\n"
    "ld1b { z2.h }, p4/Z, [x14, #3, MUL VL]\n"
    "ld1b { z7.h }, p4/Z, [x14, #4, MUL VL]\n"
    "ld1b { z10.h }, p4/Z, [x14, #5, MUL VL]\n"
    "ld1b { z26.h }, p4/Z, [x14, #6, MUL VL]\n"
    "ld1b { z20.h }, p4/Z, [x14, #7, MUL VL]\n"
    "inch x14, ALL, MUL #8\n"
    ...
    ".inst 0x455e1a94  // usublb z20.h, z20.b, z30.b\n"
