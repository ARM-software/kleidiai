...
)
{
  __asm__ __volatile__(
    ...
    "cbz %x[rq_mul_ptr], 3f\n"
    "lsl x20, x9, #0x2\n"
    "ldr q8, [%x[rq_mul_ptr], x20]\n"
    "ldr q7, [%x[rq_right_shift_ptr], x20]\n"
    "cbz %x[rq_left_shift_ptr], 3f\n"
    "ldr q9, [%x[rq_left_shift_ptr], x20]\n"
    ...
    "ldr s6, [%x[weights]], #0x4\n"
    "ldp x21, x20, [x22], #0x10\n"
    "smlal v16.4s, v5.4h, v4.h[0]\n"
    "smlal v17.4s, v5.4h, v4.h[1]\n"
    "smlal v18.4s, v5.4h, v4.h[2]\n"
    "smlal v19.4s, v5.4h, v4.h[3]\n"
    "smlal v20.4s, v5.4h, v4.h[4]\n"
    "smlal v21.4s, v5.4h, v4.h[5]\n"
    "usubl v0.8h, v0.8b, v12.8b\n"
    "smlal v22.4s, v5.4h, v4.h[6]\n"
    "smlal v23.4s, v5.4h, v4.h[7]\n"
    "ldr d4, [x21, #0]\n"
    "usubl v6.8h, v6.8b, v11.8b\n"
    "smlal v24.4s, v5.4h, v3.h[0]\n"
    "smlal v25.4s, v5.4h, v3.h[1]\n"
    "smlal v26.4s, v5.4h, v3.h[2]\n"
    "smlal v27.4s, v5.4h, v3.h[3]\n"
    "smlal v28.4s, v5.4h, v3.h[4]\n"
    "smlal v29.4s, v5.4h, v3.h[5]\n"
    "usubl v4.8h, v4.8b, v12.8b\n"
    "smlal v30.4s, v5.4h, v3.h[6]\n"
    "smlal v31.4s, v5.4h, v3.h[7]\n"
    "ldr d3, [x20, #0]\n"
    "ldr s5, [%x[weights]], #0x4\n"
    "usubl v3.8h, v3.8b, v12.8b\n"
    "usubl v5.8h, v5.8b, v11.8b\n"
    ...
    "sqdmulh v16.4s, v16.4s, v8.4s\n"
    "sqdmulh v17.4s, v17.4s, v8.4s\n"
    "sqdmulh v18.4s, v18.4s, v8.4s\n"
    "sqdmulh v19.4s, v19.4s, v8.4s\n"
    "sqdmulh v20.4s, v20.4s, v8.4s\n"
    "sqdmulh v21.4s, v21.4s, v8.4s\n"
    "sqdmulh v22.4s, v22.4s, v8.4s\n"
    "sqdmulh v23.4s, v23.4s, v8.4s\n"
    ...
    "sqdmulh v24.4s, v24.4s, v8.4s\n"
    "sqdmulh v25.4s, v25.4s, v8.4s\n"
    "sqdmulh v26.4s, v26.4s, v8.4s\n"
    "sqdmulh v27.4s, v27.4s, v8.4s\n"
    "sqdmulh v28.4s, v28.4s, v8.4s\n"
    "sqdmulh v29.4s, v29.4s, v8.4s\n"
    "sqdmulh v30.4s, v30.4s, v8.4s\n"
    "sqdmulh v31.4s, v31.4s, v8.4s\n"
    ...
    "smlal v24.4s, v1.4h, v0.h[0]\n"
    "smlal v25.4s, v1.4h, v0.h[1]\n"
    "sshl v16.4s, v16.4s, v9.4s\n"
    "smlal v26.4s, v1.4h, v0.h[2]\n"
    "smlal v27.4s, v1.4h, v0.h[3]\n"
    "sshl v17.4s, v17.4s, v9.4s\n"
    "smlal v28.4s, v1.4h, v0.h[4]\n"
    "smlal v29.4s, v1.4h, v0.h[5]\n"
    "sshl v18.4s, v18.4s, v9.4s\n"
    "smlal v30.4s, v1.4h, v0.h[6]\n"
    "smlal v31.4s, v1.4h, v0.h[7]\n"
    "sshl v19.4s, v19.4s, v9.4s\n"
    "sshl v20.4s, v20.4s, v9.4s\n"
    "sshl v21.4s, v21.4s, v9.4s\n"
    "sshl v22.4s, v22.4s, v9.4s\n"
    ...
    : "cc", "memory", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v16", "v17", "v18", "v19", "v20", "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30", "v31", "x9", "x10", "x20", "x21", "x22", "x23", "x24", "x25", "x26", "x27", "x28"
  );
}
