...
)
{
  ...
  __asm__ __volatile__(
    ...
    "ld1sb { z21.h }, p4/Z, [x16]\n"
    "ld1sb { z13.h }, p4/Z, [x16, #1, MUL VL]\n"
    "ld1sb { z1.h }, p4/Z, [x16, #2, MUL VL]\n"
    "ld1sb { z8.h }, p4/Z, [x16, #3, MUL VL]\n"
    "ld1sb { z26.h }, p4/Z, [x16, #4, MUL VL]\n"
    "ld1sb { z9.h }, p4/Z, [x16, #5, MUL VL]\n"
    "ld1sb { z25.h }, p4/Z, [x16, #6, MUL VL]\n"
    "ld1sb { z16.h }, p4/Z, [x16, #7, MUL VL]\n"
    "inch x16, ALL, MUL #8\n"
    ".inst 0x454f12b5  // ssublb z21.h, z21.b, z15.b\n"
    "ld1w { z18.s }, p2/Z, [x25]\n"
    ...
    "ld1sb { z19.h }, p4/Z, [x16]\n"
    "ldp x27, x26, [x15, #0]\n"
    ".inst 0x454f135a  // ssublb z26.h, z26.b, z15.b\n"
    ".inst 0x454f1129  // ssublb z9.h, z9.b, z15.b\n"
    ...
    ".inst 0x454f1210  // ssublb z16.h, z16.b, z15.b\n"
    ".inst 0x454f1273  // ssublb z19.h, z19.b, z15.b\n"
    ...
    "mov z22.d, z5.d\n"
    "ld1sb { z30.h }, p3/Z, [x27, x8]\n"
    "ld1sb { z7.h }, p3/Z, [x26, x8]\n"
    "ld1sb { z28.h }, p3/Z, [x25, x8]\n"
    "ld1sb { z18.h }, p3/Z, [x24, x8]\n"
    "ld1sb { z31.h }, p3/Z, [x23, x8]\n"
    "ld1sb { z6.h }, p3/Z, [x22, x8]\n"
    "ld1sb { z24.h }, p3/Z, [x21, x8]\n"
    "ld1sb { z20.h }, p3/Z, [x20, x8]\n"
    ".inst 0x454e13de  // ssublb z30.h, z30.b, z14.b\n"
    ...
    "ld1sb { z6.h }, p3/Z, [x21, x8]\n"
    ".inst 0x44954680  // smlalt z0.s, p4/M, z20.h, z21.h\n"
    "ld1sb { z21.h }, p3/Z, [x20, x8]\n"
    ...
    ".inst 0x454e11ad  // ssublb z13.h, z13.b, z14.b\n"
