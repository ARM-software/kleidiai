...
static size_t kai_get_rhs_packed_stride_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla(size_t k) {
    return kai_get_nr_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla() *
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla(size_t n_idx, size_t k) {
    KAI_ASSUME(n_idx % kai_get_nr_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla() == 0);

    const size_t block_idx = n_idx / kai_get_nr_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla();
