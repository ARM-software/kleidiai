...
/// -# @ref kai_rhs_pack_nxk_qsi4c32ps1s0nrx4_qsu4c32s1s0_neon to pack the RHS NxK matrix.
/// -# @ref kai_rhs_pack_kxn_qsi4c32ps1s0nrx4_qsu4c32s1s0_neon to pack the RHS KxN matrix.
...
/// the @ref kai_rhs_pack_nxk_qsi4c32ps1s0nrx4_qsu4c32s1s0_neon micro-kernel.
///
/// @return the nr value
...
/// which contains the packed Quantized Symmetric Signed 4-bit with per-block-32 quantization (qsi4c32p) values.
///
...
size_t kai_get_dst_size_matmul_clamp_f32_qai8dxp1vlx4_qsi4c32p4vlx4_1vlx4vl_sme_mopa(size_t m, size_t n);
...
/// RHS matrix: Quantized Symmetric Signed 4-bit with per-block-32 quantization (qsi4c32p) and packed.
