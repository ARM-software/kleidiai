...
size_t kai_get_lhs_packed_offset_matmul_clamp_f32_qai8dxp1x4_qsi8cxp32x4_1x32_sve_dotprod(
    size_t m_idx,  //
    size_t k);     //
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_qai8dxp1x4_qsi8cxp32x4_1x32_sve_dotprod(
    size_t n_idx,  //
    size_t k);     //
...
size_t kai_get_dst_size_matmul_clamp_f32_qai8dxp1x4_qsi8cxp32x4_1x32_sve_dotprod(
    size_t m,   //
    size_t n);  //
...
///
/// Note:
/// - This kernel only supports 256-bit SVE vector lengths.
/// - Please refer to the get functions for m_step and n_step for the exact values.
///
/// Features used: SVE dotprod
///
