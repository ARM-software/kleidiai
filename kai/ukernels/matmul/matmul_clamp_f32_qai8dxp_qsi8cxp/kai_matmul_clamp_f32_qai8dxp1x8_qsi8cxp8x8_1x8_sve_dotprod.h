...
///
/// -# @ref kai_lhs_quant_pack_qai8dxp_f32_neon to dynamically quantize and pack the LHS matrix in a single step.
...
size_t kai_get_lhs_packed_offset_matmul_clamp_f32_qai8dxp1x8_qsi8cxp8x8_1x8_sve_dotprod(
    size_t m_idx,  //
    size_t k);     //
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_qai8dxp1x8_qsi8cxp8x8_1x8_sve_dotprod(
    size_t n_idx,  //
    size_t k);     //
...
size_t kai_get_dst_size_matmul_clamp_f32_qai8dxp1x8_qsi8cxp8x8_1x8_sve_dotprod(
    size_t m,   //
    size_t n);  //
