...
///
///   * RHS: @ref kai_get_rhs_offset_rhs_pack_nxk_x16p32x1bx16_x16_x16_neon.
///   * Bias: @ref kai_get_bias_offset_rhs_pack_nxk_x16p32x1bx16_x16_x16_neon.
///   * Output: @ref kai_get_rhs_packed_offset_rhs_pack_nxk_x16p32x1bx16_x16_x16_neon.
///
...
/// @param[in] nr Block size in N dimension. It must match kai_get_n_step_rhs_pack_nxk_x16p32x1bx16_x16_x16_neon().
...
/// @param[in] bias Bias matrix data buffer. It can be NULL, in which case the packed bias is zero-filled.
