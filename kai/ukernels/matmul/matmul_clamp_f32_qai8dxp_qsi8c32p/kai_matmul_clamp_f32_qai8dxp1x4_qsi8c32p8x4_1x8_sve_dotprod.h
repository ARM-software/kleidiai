...
size_t kai_get_lhs_packed_offset_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(
    size_t m_idx,  //
    size_t k);     //

/// Gets the offset in bytes for the packed RHS matrix,
/// which contains the packed Quantized Symmetric Signed 8-bit with per-block (32) quantization (qsi8c32) values.
///
...
size_t kai_get_dst_size_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(
    size_t m,   //
    size_t n);  //
...
/// RHS matrix: Quantized Symmetric Signed 8-bit with per-block (32) quantization (qsi8c32) and packed.
