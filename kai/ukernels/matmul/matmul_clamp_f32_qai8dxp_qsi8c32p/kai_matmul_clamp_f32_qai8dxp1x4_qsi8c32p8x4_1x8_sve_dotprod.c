...
//
#if (!defined(__aarch64__) || !defined(__ARM_FEATURE_SVE) || !defined(__ARM_FEATURE_DOTPROD)) && !defined(_M_ARM64)
#error "Dotprod extension, FEAT_SVE required to compile this micro-kernel"
#else  // Architectural features check.

#include "kai_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod.h"
...
void kai_kernel_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(KernelArgs* args_ptr);
...
inline static size_t kai_get_num_bytes_per_block_rhs(size_t bl) {
    ...
    size_t num_bytes_per_block_rhs = (bl * kai_num_bytes_qvalue_rhs) + kai_num_bytes_multiplier_rhs;
...
size_t kai_get_m_step_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(void) {
    return kai_m_step;
}

size_t kai_get_n_step_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(void) {
    return kai_n_step;
}

size_t kai_get_mr_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(void) {
    return kai_mr;
}

size_t kai_get_nr_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(void) {
    return kai_nr;
}

size_t kai_get_kr_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(void) {
    return kai_kr;
}

size_t kai_get_sr_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(void) {
    return kai_sr;
}

size_t kai_get_lhs_packed_offset_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(size_t m_idx, size_t k) {
    KAI_ASSUME((m_idx % kai_m_step) == 0);

    return (m_idx / kai_mr) * kai_get_lhs_packed_stride(k);
}

size_t kai_get_rhs_packed_offset_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(
...
size_t kai_get_dst_offset_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(
...
size_t kai_get_dst_size_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(size_t m, size_t n) {
    return m * n * kai_num_bytes_dst_value;
}

void kai_run_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(
    size_t m,                         //
    size_t n,                         //
    size_t k,                         //
    size_t bl,                        //
    ...
    kai_kernel_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod(&args);
}
