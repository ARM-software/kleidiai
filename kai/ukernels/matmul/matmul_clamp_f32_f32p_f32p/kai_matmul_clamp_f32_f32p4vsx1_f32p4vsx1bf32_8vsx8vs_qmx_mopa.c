...
void kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_4vsx4vs_qmx_mopa(
    const struct kai_matmul_uker_args_internal* args);
void kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_4vsx8vs_qmx_mopa(
    const struct kai_matmul_uker_args_internal* args);
void kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_4vsx16vs_qmx_mopa(
    const struct kai_matmul_uker_args_internal* args);
void kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_8vsx4vs_qmx_mopa(
    const struct kai_matmul_uker_args_internal* args);
void kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_8vsx8vs_qmx_mopa(
    const struct kai_matmul_uker_args_internal* args);
void kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_16vsx4vs_qmx_mopa(
    const struct kai_matmul_uker_args_internal* args);
...
static void run(const struct kai_matmul_uker_config* config, const struct kai_matmul_uker_args* args) {
    ...
    if (main_m > 0 && main_n > 0) {
        ...
        kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_8vsx8vs_qmx_mopa(&uker_args);
    }
    ...
    if (main_m > 0 && args->shape.n > main_n) {
        ...
        if (shape_m_16vs > 0) {
            ...
            kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_16vsx4vs_qmx_mopa(&uker_args);
        ...
        if (leftover_m > 0) {
            ...
            kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_8vsx4vs_qmx_mopa(&uker_args);
        }
    }
    ...
    if (args->shape.m > main_m && args->shape.n > 0) {
        ...
        if (shape_n_16vs > 0) {
            ...
            kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_4vsx16vs_qmx_mopa(&uker_args);
        ...
        if (shape_n_8vs > 0) {
            ...
            kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_4vsx8vs_qmx_mopa(&uker_args);
        ...
        if (leftover_n > 0) {
            ...
            kai_kernel_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_4vsx4vs_qmx_mopa(&uker_args);
        }
    }
}
