...
void kai_kernel_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot(const KernelArgs* args);
...
static size_t kai_get_mr_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot(void);
static size_t kai_get_nr_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot(void);
...
inline static size_t kai_get_lhs_packed_stride(size_t k, size_t bl) {
    const size_t mr = kai_get_mr_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot();
...
inline static size_t kai_get_rhs_packed_stride(size_t k, size_t bl) {
    ...
    const size_t nr = kai_get_nr_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot();
...
static size_t kai_get_m_step_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot(void) {
    return kai_m_step;
}

static size_t kai_get_n_step_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot(void) {
...
static void run_internal_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot(
    size_t m,                         //
    size_t n,                         //
    size_t k,                         //
    size_t bl,                        //
    ...
    float scalar_min,                 //
    float scalar_max,                 //
    const int32_t* lut_arg) {
    KAI_ASSUME(dst_stride_col == sizeof(float));
    const int32_t* lut = lut_arg != NULL ? lut_arg : default_lut;
    KAI_ASSUME(m == 1);
    KAI_ASSUME((bl % kai_bl) == 0);
    ...
    kai_commit_za();
    kai_kernel_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot(&ka);
}
...
static struct kai_matmul_uker_dim_args get_step(const struct kai_matmul_uker_config* config) {
    ...
    return (struct kai_matmul_uker_dim_args){
        .m = kai_get_m_step_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot(),
        .n = kai_get_n_step_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot(),
        .k = 0};
}
...
static size_t get_lhs_offset(
    ...
    return index->m / kai_get_mr_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot() * stride->m;
}
...
static size_t get_rhs_offset(
    ...
    KAI_UNUSED(config);
    KAI_ASSUME(index->k == 0);
    return index->n / kai_get_nr_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot() * stride->n;
}
...
static void run(const struct kai_matmul_uker_config* config, const struct kai_matmul_uker_args* args) {
    ...
    run_internal_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s16s0sf16_1x16vs_sme2_dot(
        args->shape.m, args->shape.n, args->shape.k, config->format.bl, args->operand.lhs.ptr, args->operand.rhs.ptr,
        (float*)args->operand.dst.ptr, args->operand.dst.stride.m, sizeof(float), min, max, (const int32_t*)args->lut);
}
