...
#include "kai_dwconv_clamp_f16_f16_f16p1vlx1b_3x3_s1_4x4_sme2_mla.h"
...
void kai_kernel_dwconv_clamp_f16_f16_f16p1vlx1b_3x3_s1_4x4_sme2_mla(const KernelArgs* args, size_t n_channels);
uint16_t kai_f16_from_float_dwconv_clamp_f16_f16_f16p1vlx1b_3x3_s1_4x4_sme2_mla(float value);

size_t kai_get_filter_height_dwconv_clamp_f16_f16_f16p1vlx1b_3x3_s1_4x4_sme2_mla(void) {
    return kai_filter_height;
}

size_t kai_get_filter_width_dwconv_clamp_f16_f16_f16p1vlx1b_3x3_s1_4x4_sme2_mla(void) {
    return kai_filter_width;
}

size_t kai_get_dst_size_dwconv_clamp_f16_f16_f16p1vlx1b_3x3_s1_4x4_sme2_mla(
    size_t dst_height, size_t dst_width, size_t num_channels) {
    return dst_height * dst_width * num_channels * sizeof(uint16_t);
}

void kai_run_dwconv_clamp_f16_f16_f16p1vlx1b_3x3_s1_4x4_sme2_mla(
        ...
        for (size_t n_start = 0; n_start < dst_cols; n_start += KAI_N_STEP) {
            ...
            for (size_t channel_start = 0; channel_start < num_channels; channel_start += kai_channel_step) {
                ...
                KernelArgs args = {
                    ...
                    .min = kai_f16_from_float_dwconv_clamp_f16_f16_f16p1vlx1b_3x3_s1_4x4_sme2_mla(clamp_min),
                    .max = kai_f16_from_float_dwconv_clamp_f16_f16_f16p1vlx1b_3x3_s1_4x4_sme2_mla(clamp_max)};

                kai_commit_za();

                kai_kernel_dwconv_clamp_f16_f16_f16p1vlx1b_3x3_s1_4x4_sme2_mla(&args, n_channels);
            }
        }
    }
}
