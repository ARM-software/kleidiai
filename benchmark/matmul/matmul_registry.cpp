...
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_f32_f16p4vsx2_qsi4c32p16vsx4s1s0sf16_f16p_4vsx16vs_sme2_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{.format = {.bl = 32}}; },
        .get_api = kai_matmul_clamp_f32_f16p4vsx2_qsi4c32p16vsx4s1s0sf16_f16p_4vsx16vs_sme2_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
    };
...
inline constexpr MatMulUkernelApiInterface kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp32x4_1x32_sve_dot_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp32x4_1x32_sve_dot,
    .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
};
...
inline constexpr MatMulUkernelApiInterface kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp8x4_1x8_sve_dot_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp8x4_1x8_sve_dot,
    .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
};
...
inline constexpr MatMulUkernelApiInterface kai_matmul_clamp_f32_qai8dxp1x8_qsi8cxp8x8_1x8_sve_dot_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_clamp_f32_qai8dxp1x8_qsi8cxp8x8_1x8_sve_dot,
    .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
};
...
// matmul_clamp_f32_qsi8d32p_qsi4c32p
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s1s0sf16_i8p_1x16vs_sme2_dot_interface{
        .get_config = [] { return kai_matmul_uker_config{.format = {.bl = 32}}; },
        .get_api = kai_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s1s0sf16_i8p_1x16vs_sme2_dot,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
    };

inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_f32_qsi8d32p4vsx4sf16_qsi4c32p16vsx4s1s0sf16_i8p_4vsx16vs_sme2_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{.format = {.bl = 32}}; },
        .get_api = kai_matmul_clamp_f32_qsi8d32p4vsx4sf16_qsi4c32p16vsx4s1s0sf16_i8p_4vsx16vs_sme2_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
    };
...
/// Returns the lazily registered matmul benchmarks.
///
/// @return Registered matmul benchmarks.
const auto& get_matmul_benchmarks() {
    static const std::array matmul_benchmarks{
        // matmul_clamp_f16_bf16p_bf16p
        RegisterBenchmark(
        ...
        RegisterBenchmark(
            ...
            kai_matmul_clamp_f16_f16_f16p32x1b_6x32_neon_mla_interface, DataType::FP16, MatMulOp::GEMM,
            test::cpu_has_fp16),
        RegisterBenchmark(
            "kai_matmul_clamp_f16_f16_f16p32x1b_6x32_neon_mla_cortexa55",
            kai_benchmark_matmul<MatMulStridedLhsInterface>,
        ...
        RegisterBenchmark(
            ...
            kai_benchmark_matmul<MatMulUkernelApiInterface>,
            kai_matmul_clamp_f32_f16p4vsx2_qsi4c32p16vsx4s1s0sf16_f16p_4vsx16vs_sme2_mopa_interface, DataType::FP32,
        ...
        RegisterBenchmark(
            ...
            kai_matmul_clamp_f32_f32_f32p2vlx1b_1x8vl_sme_mla_interface, DataType::FP32, MatMulOp::GEMV,
            test::cpu_has_sme),
        RegisterBenchmark(
        ...
        RegisterBenchmark(
            ...
            kai_matmul_clamp_f32_f32_f32p4vlx1b_6x4vl_sve_mla_interface, DataType::FP32, MatMulOp::GEMM,
            test::cpu_has_sve),
        RegisterBenchmark(
        ...
        RegisterBenchmark(
            ...
            kai_benchmark_matmul<MatMulUkernelApiInterface>,
            kai_matmul_clamp_f32_f32p4vsx1_f32p4vsx1b_8vsx8vs_elastic_sme2_mopa_interface, DataType::FP32,
        ...
        RegisterBenchmark(
            ...
            kai_matmul_clamp_f32_qai8dxp1x4_qsu2cxp4x4bf32sf32_1x4_neon_dotprod_interface, DataType::FP32,
            MatMulOp::GEMV, test::cpu_has_dotprod),
        RegisterBenchmark(
        ...
        RegisterBenchmark(
            ...
            kai_benchmark_matmul<MatMulFloatInterface>,
        ...
        RegisterBenchmark(
            ...
            test::cpu_has_sme),
        RegisterBenchmark(
            "kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp32x4_1x32_sve_dot", kai_benchmark_matmul<MatMulUkernelApiInterface>,
            kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp32x4_1x32_sve_dot_interface, DataType::FP32, MatMulOp::GEMV,
            test::cpu_has_sve_vl256),
        RegisterBenchmark(
            ...
            test::cpu_has_dotprod),
        RegisterBenchmark(
            "kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp8x4_1x8_sve_dot", kai_benchmark_matmul<MatMulUkernelApiInterface>,
            kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp8x4_1x8_sve_dot_interface, DataType::FP32, MatMulOp::GEMV,
            test::cpu_has_sve_vl256),
        RegisterBenchmark(
            ...
            test::cpu_has_dotprod),
        RegisterBenchmark(
            "kai_matmul_clamp_f32_qai8dxp1x8_qsi8cxp8x8_1x8_sve_dot", kai_benchmark_matmul<MatMulUkernelApiInterface>,
            kai_matmul_clamp_f32_qai8dxp1x8_qsi8cxp8x8_1x8_sve_dot_interface, DataType::FP32, MatMulOp::GEMV,
            test::cpu_has_sve_vl256),
        RegisterBenchmark(
        ...
        // matmul_clamp_f32_qsi8d32p_qsi4c32p
        RegisterBenchmark(
            "kai_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s1s0sf16_i8p_1x16vs_sme2_dot",
            kai_benchmark_matmul<MatMulUkernelApiInterface>,
            kai_matmul_clamp_f32_qsi8d32p1x4sf16_qsi4c32p16vsx4s1s0sf16_i8p_1x16vs_sme2_dot_interface, DataType::FP32,
            MatMulOp::GEMV, test::cpu_has_sme2),
        RegisterBenchmark(
            "kai_matmul_clamp_f32_qsi8d32p4vsx4sf16_qsi4c32p16vsx4s1s0sf16_i8p_4vsx16vs_sme2_mopa",
            kai_benchmark_matmul<MatMulUkernelApiInterface>,
            kai_matmul_clamp_f32_qsi8d32p4vsx4sf16_qsi4c32p16vsx4s1s0sf16_i8p_4vsx16vs_sme2_mopa_interface,
            DataType::FP32, MatMulOp::GEMM, test::cpu_has_sme2),
        RegisterBenchmark(
            "kai_matmul_clamp_f32_qsi8d32p1vlx4_qsi4c32p4vlx4_1vlx4vl_sme2_mopa",
            kai_benchmark_matmul<MatMulBlockwiseDynamicQuantInterface>,
            kai_matmul_clamp_f32_qsi8d32p1vlx4_qsi4c32p4vlx4_1vlx4vl_sme2_mopa_interface, DataType::FP32,
            MatMulOp::GEMM, test::cpu_has_sme2),
        RegisterBenchmark(
        ...
        RegisterBenchmark(
            ...
            kai_benchmark_matmul<MatMulBaseInterface>,
        ...
        RegisterBenchmark(
            ...
            kai_benchmark_matmul<MatMulBlockwiseDynamicQuantGenericDstInterface>,
            kai_matmul_clamp_f16_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_sme2_mopa_interface, DataType::FP16,
            MatMulOp::GEMM, test::cpu_has_sme2),
        RegisterBenchmark(
        ...
        RegisterBenchmark(
            ...
            kai_benchmark_matmul<MatMulBlockwiseDynamicQuantInterface>,
            kai_matmul_clamp_f32_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_sme2_mopa_interface, DataType::FP32,
            MatMulOp::GEMM, test::cpu_has_sme2),
        RegisterBenchmark(
    ...
    return matmul_benchmarks;
}

void RegisterMatMulBenchmarks(const MatMulShape& shape, const size_t bl) {
    for (const auto& benchmark : get_matmul_benchmarks()) {
        benchmark
            ->Args(
