...
#include "kai/ukernels/matmul/matmul_clamp_f32_qai8dxp_qsi8cxp/kai_matmul_clamp_f32_qai8dxp4x8_qsi8cxp8x8_16x8_sve_i8mm.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f16_qai8dxp_qsi4cxp/kai_matmul_clamp_f16_qai8dxp4x8_qsi4cxp8x8_16x8_sve2p1_i8mm.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f16_qai8dxp_qsi8cxp/kai_matmul_clamp_f16_qai8dxp1x4_qsi8cxp8x4_1x8_sve2_dotprod.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f16_qai8dxp_qsi8cxp/kai_matmul_clamp_f16_qai8dxp4x8_qsi8cxp8x8_16x8_sve2_i8mm.h"
...
// matmul_clamp_f32_qai8dxp_qsi8c32p
inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod,
    };

inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_qai8dxp4x8_qsi8c32p8x8_16x8_sve_i8mm_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qai8dxp4x8_qsi8c32p8x8_16x8_sve_i8mm,
    };
...
inline constexpr MatMulFloatInterface kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp32x4_1x32_sve_dotprod_interface{
    .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1x4_qsi8cxp32x4_1x32_sve_dotprod,
};
...
inline constexpr MatMulFloatInterface kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp8x4_1x8_sve_dotprod_interface{
    .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1x4_qsi8cxp8x4_1x8_sve_dotprod,
};
...
inline constexpr MatMulFloatInterface kai_matmul_clamp_f32_qai8dxp1x8_qsi8cxp8x8_1x8_sve_dotprod_interface{
    .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1x8_qsi8cxp8x8_1x8_sve_dotprod,
};
...
inline constexpr MatMulFloatInterface kai_matmul_clamp_f32_qai8dxp4x8_qsi8cxp8x8_16x8_sve_i8mm_interface{
    .run_matmul = kai_run_matmul_clamp_f32_qai8dxp4x8_qsi8cxp8x8_16x8_sve_i8mm,
};
...
inline constexpr MatMulBaseInterface kai_matmul_clamp_f16_qai8dxp4x8_qsi4cxp8x8_16x8_sve2p1_i8mm_interface{
    .run_matmul = kai_run_matmul_clamp_f16_qai8dxp4x8_qsi4cxp8x8_16x8_sve2p1_i8mm,
};
...
inline constexpr MatMulBaseInterface kai_matmul_clamp_f16_qai8dxp1x4_qsi8cxp8x4_1x8_sve2_dotprod_interface{
    .run_matmul = kai_run_matmul_clamp_f16_qai8dxp1x4_qsi8cxp8x4_1x8_sve2_dotprod,
};
...
inline constexpr MatMulBaseInterface kai_matmul_clamp_f16_qai8dxp4x8_qsi8cxp8x8_16x8_sve2_i8mm_interface{
    .run_matmul = kai_run_matmul_clamp_f16_qai8dxp4x8_qsi8cxp8x8_16x8_sve2_i8mm,
};
...
inline const std::array matmul_benchmarks{
    ...
    // matmul_clamp_f32_qai8dxp_qsi8c32p
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantInterface>,
        kai_matmul_clamp_f32_qai8dxp1x4_qsi8c32p8x4_1x8_sve_dotprod_interface, DataType::FP32, MatMulOp::GEMV,
        (test::cpu_check<test::cpu_has_sve_vl256, test::cpu_has_dotprod>)),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp4x8_qsi8c32p8x8_16x8_sve_i8mm",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantInterface>,
        kai_matmul_clamp_f32_qai8dxp4x8_qsi8c32p8x8_16x8_sve_i8mm_interface, DataType::FP32, MatMulOp::GEMM,
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp32x4_1x32_sve_dotprod", kai_benchmark_matmul<MatMulFloatInterface>,
        kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp32x4_1x32_sve_dotprod_interface, DataType::FP32, MatMulOp::GEMV,
        (test::cpu_check<test::cpu_has_sve_vl256, test::cpu_has_dotprod>)),
    RegisterBenchmark(
        ...
        test::cpu_has_dotprod),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp8x4_1x8_sve_dotprod", kai_benchmark_matmul<MatMulFloatInterface>,
        kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp8x4_1x8_sve_dotprod_interface, DataType::FP32, MatMulOp::GEMV,
        (test::cpu_check<test::cpu_has_sve_vl256, test::cpu_has_dotprod>)),
    RegisterBenchmark(
        ...
        test::cpu_has_dotprod),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1x8_qsi8cxp8x8_1x8_sve_dotprod", kai_benchmark_matmul<MatMulFloatInterface>,
        kai_matmul_clamp_f32_qai8dxp1x8_qsi8cxp8x8_1x8_sve_dotprod_interface, DataType::FP32, MatMulOp::GEMV,
        (test::cpu_check<test::cpu_has_sve_vl256, test::cpu_has_dotprod>)),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_i8mm),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp4x8_qsi8cxp8x8_16x8_sve_i8mm", kai_benchmark_matmul<MatMulFloatInterface>,
        kai_matmul_clamp_f32_qai8dxp4x8_qsi8cxp8x8_16x8_sve_i8mm_interface, DataType::FP32, MatMulOp::GEMM,
        (test::cpu_check<test::cpu_has_sve_vl256, test::cpu_has_sve2, test::cpu_has_i8mm>)),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        "kai_matmul_clamp_f16_qai8dxp4x8_qsi4cxp8x8_16x8_sve2p1_i8mm", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f16_qai8dxp4x8_qsi4cxp8x8_16x8_sve2p1_i8mm_interface, DataType::FP16, MatMulOp::GEMM,
        test::cpu_check<test::cpu_has_sve2p1, test::cpu_has_sve_vl256, test::cpu_has_i8mm>),
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_dotprod_and_fp16),
    RegisterBenchmark(
        "kai_matmul_clamp_f16_qai8dxp1x4_qsi8cxp8x4_1x8_sve2_dotprod", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f16_qai8dxp1x4_qsi8cxp8x4_1x8_sve2_dotprod_interface, DataType::FP16, MatMulOp::GEMV,
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_i8mm_and_fp16),
    RegisterBenchmark(
        "kai_matmul_clamp_f16_qai8dxp4x8_qsi8cxp8x8_16x8_sve2_i8mm", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f16_qai8dxp4x8_qsi8cxp8x8_16x8_sve2_i8mm_interface, DataType::FP16, MatMulOp::GEMM,
        (test::cpu_check<test::cpu_has_sve_vl256, test::cpu_has_sve2, test::cpu_has_i8mm>)),
