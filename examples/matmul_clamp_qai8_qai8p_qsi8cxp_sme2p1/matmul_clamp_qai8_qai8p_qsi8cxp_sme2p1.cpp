...
Mop4Result run_mop4(
    ...
    args.dst_bias_n_ptr = &dst_zero_point;
...
int main(void) {
    ...
    add_2vsx32vs("long K first block", half_vl, n_tile, 261, i8_min, i8_max, kDstZeroPoint);
    add_2vsx32vs("long K pair tail", half_vl, n_tile, 273, i8_min, i8_max, kDstZeroPoint);
    add_2vsx32vs("long K single tail", half_vl, n_tile, 280, i8_min, i8_max, kDstZeroPoint);
