...
Span<const MatMulOperator> get_available_matmul_operators() {
    ...
    operators[5].name = "matmul_clamp_f32_f32_f32p4vsx1b_1x32vs_sme2_mla";
    ...
    operators[5].is_shape_suitable = [](size_t shape_m, size_t shape_n, size_t shape_k, const MatrixPortion& portion) {
        return shape_m == 1 && is_shape_suitable_lhs_x32p4vsx1_x32_sme(shape_m, shape_n, shape_k, portion) &&
            is_shape_suitable_rhs_kxn_x32p4vsx1bx32_x32_x32_sme(shape_m, shape_n, shape_k, portion);
    };
    ...
    operators[5].pack_lhs = std::nullopt;
    operators[5].pack_rhs = create_matmul_pack_rhs_kxn_x32p4vsx1bx32_x32_x32_sme();
    operators[5].matmul = create_matmul_clamp_f32_f32_f32p4vsx1bf32_1x32vs_sme2_mla();

    // kai_matmul_clamp_f32_f32_f32p4vsx1b_1x32vs_sme2_mla - transposed RHS.
    operators[6].name = "matmul_clamp_t_f32_f32_f32p4vsx1b_1x32vs_sme2_mla";
    ...
    operators[6].matmul = create_matmul_clamp_f32_f32_f32p4vsx1bf32_1x32vs_sme2_mla();
